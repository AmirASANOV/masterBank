  ...
  return React.createElement(
    props.titleType || 'h2',
    {
      className:
        ...
        defaultClassName[props.titleType || 'h2'] ||
        'title-text fs-30-24-17 color-black-main',
      style:
        props.titleMargins || props.titlePaddings
          ? {
              ...props.titleStyle,
              textAlign: props.titleTextAlign
                ? props.titleTextAlign[viewport]
                : props.titleStyle?.textAlign || 'inherit',
              margin: props.titleMargins
                ? getGutters(props.titleMargins[viewport])
                : props.titleStyle?.margin || null,
              padding: props.titlePaddings
                ? getGutters(props.titlePaddings[viewport])
                : props.titleStyle?.padding || null,
            }
          : {
              ...props.titleStyle,
              textAlign: props.titleTextAlign
